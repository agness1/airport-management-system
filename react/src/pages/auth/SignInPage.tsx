...
<div className="flex">
    ...
    <div className="flex lg:w-1/2 flex-col justify-center mx-auto  px-6 py-12 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        {
    message ? <p className="text-red-700 font-bold text-lg">{message}</p> : ""
    }
          <div>
            <label  className="block text-sm font-medium leading-6 text-gray-900">Email address</label>
            <div className="mt-2">
              <input ref={emailRef} id="email" name="email" type="email"   className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
            </div>
          </div>
          <div>
